...
threading.Thread(target=principal,args=(idt1,idt2,motdp1,motdp2,altenative_idt))
threading.Thread(target=principal,args=(idt3,idt4,motdp3,motdp4,altenative_idt))
